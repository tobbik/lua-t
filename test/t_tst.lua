...
local tests = {
	...
	test_TodoFails = function( self, done )
		...
		self.t.test_Test = function( s ) Test.todo('todo'); assert( false, "This better fails" ) end
	...
	test_TodoSuccess = function( self, done )
		...
		self.t.test_Test = function( s ) Test.todo('todo'); assert( true,  "This better works" ) end
		assert( not self.t(), "Test suite should have failed" )
		assert( self.t.test_Test.todo == "todo", "Test Todo reason should be set" )
		assert( self.t.test_Test.pass, "Test.test_Test case suite should have passed" )
	end,
	...
	test_Skip = function( self, done )
		...
		self.t.test_Test = function( s ) Test.skip('skip me'); assert( false,  "This better fails" ) end
	...
	test_Description = function( self, done )
		...
		self.t.test_Test = function( s ) Test.describe('describe me'); assert( true,  "This better works" ) end
